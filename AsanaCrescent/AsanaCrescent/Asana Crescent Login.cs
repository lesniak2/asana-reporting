...
namespace AsanaCrescent
{
    public partial class Crescent : Form
    {
        ...
        public Crescent()
        {
            ...
            this.tabControl.VisibleChanged += new System.EventHandler(TabControl_VisibleChanged);
        ...
        private void AddTabCheckbox(AsanaTask task, int TabIndex)
        {
            if (!CancelTaskPopulating)
            {
                ...
                {
                    this.tabControl.TabPages[TabIndex].Controls.Add(test);
                }
            }
        }
        ...
        {
            yLoc = 0;
            this.WorkspaceNothingHereLabel.Invoke(new Action(() => { this.WorkspaceNothingHereLabel.Visible = false; }));
            asana.GetWorkspaces(o =>
            {
                ...
                if (workspaces.Count == 0)
                    this.WorkspaceNothingHereLabel.Invoke(new Action(() => { this.WorkspaceNothingHereLabel.Visible = true; }));
            });
        }
        ...
        public void PopulateProjects()
        {
            ...
            asana.GetProjectsInWorkspace(WorkspaceDictionary[this.CurrentWorkspaceName], o =>
            {
                ...
                if (projects.Count == 0)
                {
                    if (this.ProjectLoadingLabel.InvokeRequired)
                    {
                ...
                if (this.ProjectLoadingLabel.InvokeRequired)
                {
                    this.ProjectLoadingLabel.Invoke(new Action(() =>
                    {
                        ...
                        this.ProjectBackButton.Enabled = true;
                    }));
                }
                else
                {
